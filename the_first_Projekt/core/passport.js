...
class Passport {
    //automatische Erzeugung eines Password
    ...
    //um ein Password zu hashen
    static hashPassword(str) {
        return bcrypt.hashSync(str, 10);
    }

    //zum Vergleichen falls der Nutzer sein Password vergessen hat oder neu hinlegen will
    static comparePassword(str, hash) {
        return bcrypt.compareSync(str, hash);
    }

    //das ist für die cookies für login, wenn man sich anlogt, soll ein cookies hintergelassen
